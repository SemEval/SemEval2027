---
title: SemEval-2027 Tasks
---

### We are pleased to announce the following tasks for [SemEval-2027](https://semeval.github.io/SemEval2027)!
...
- **[Task 2:Directional-Consistent Fine-Grained Natural Language Inference (DiCo-NLI)](https://inigolopezgazpio.net/SemEval-2027-Task-2-DiCo-NLI/)** ([[contact organizers]](mailto:inigo.lopezgazpio@gmail.com))<br> Jon Felix Apaolaza Larraya, Aitor Soroa, Rodrigo Agerri and Inigo Lopez-Gazpio
...
- **[Task 7: CLaS: Cross-Lingual Alignment and Steering of Large Language Models](https://clas-semeval2027.github.io/clas.semeval2027/task/)** ([[contact organizers]](mailto:daniil.gurgurov@dfki.de))<br> Daniil Gurgurov, Tanja Baeumel, Dana Arad, Anastasiia Sedova, Masha Fedzechkina, Josef van Genabith, Patrick Schramowski, Marius Mosbach and Simon Ostermann 
...
- **[Task 9: Analysis of Multimodal Framing in the News](https://propaganda.math.unipd.it/semeval2027task9/)** ([[contact organizers]](mailto:jpiskorski@gmail.com))<br> Jakub Piskorski, Giovanni Da San Martino, Dimitar Iliyanov Dimitrov, Yova Kementchedjhieva, Ricardo Campos, Alipio Mario Jorge, Preslav Nakov, Lidia Pivovarova and Roman Yangarber


### Emerging Topics: Agents and AI Tools

- **[Task 10: AgentRisk: Risk Evaluation, Identification, and Policy-Guided Response in Agentic Multi-Turn Interactions](https://agentrisk-semeval.lovable.app/)** ([[contact organizers]](mailto:menisorfeas@gmail.com)[[Discord]](https://discord.gg/up5vUV5yUR))<br> Orfeas Menis Mastromichalakis, Anna (Ruoxi) Shang, Giorgos Filandrianos, Angelos Vlachos, Chrysoula Zerva, Emmanouil Koukoumidis and André Martins
...
- **[Task 11: VAKRA-Advanced: Evaluating Multi-Hop Multi-Source tool-calling capabilities in Executable Environments](https://sites.google.com/view/vakrasemeval2027)** ([[contact organizers]](mailto:ankita.naik@ibm.com)),
  ([[join task mailing list]](https://groups.google.com/g/vakra-advanced))<br> Ankita Rajaram Naik, Anupama Narasimha Murthi, Benjamin T. Elder, Siyu Huo, Praveen Venkateswaran, Abdulhamid Adebayo, Sara Rosenthal and Danish Contractor 
